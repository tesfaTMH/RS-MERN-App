  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold text-slate-900 mb-4">
        About{" "}
        <span className="italic text-blue-400 text-4xl">TMH Real Estate</span>
      </h1>
      <p className="text-slate-700 mb-4">
        <span>TMH</span> Real Estate is a leading real estate that specializes
        in helping clients buy, sell, and rent properties in the most desirable
        neighborhoods Our team of experienced agents is dedicated to provide
      ...
      <p className="text-slate-700 mb-4">
        Our team agents has wealth of experience and knowledge in the real
